    ...
    <div className="min-h-screen bg-stone-50 p-4 sm:p-6 md:p-12 relative overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 border-b border-rose-100 pb-6 gap-6">
            ...
            {/* Buttons wrap automatically on mobile */}
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-stone-400">
            ...
            <p className="font-serif italic text-sm md:text-base">Unlocking the vault...</p>
          </div>
        ) : (
      ...
      {/* Expanded Letter View Modal (Highly Optimized for Mobile) */}
      <AnimatePresence>
        {selectedLetter && (
          <motion.div 
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
          ...
          >
            ...
            >
              {/* Close Button is more prominent on mobile */}
              <button 
              ...
              {/* Letter Content */}
              <div className="flex-1 p-6 md:p-12 lg:p-16 overflow-y-auto bg-[url('https://www.transparenttextures.com/patterns/lined-paper.png')] scrollbar-hide">
              ...
              {/* Images Section (Stacks at bottom on mobile) */}
              {selectedLetter.images && selectedLetter.images.length > 0 && (
                <div className="w-full md:w-[42%] bg-stone-100/40 p-6 md:p-10 flex flex-col items-center justify-center border-t md:border-t-0 md:border-l border-stone-200">
                  <div className="relative w-full max-w-[260px] md:max-w-[320px] aspect-[4/5] bg-white p-3 md:p-4 shadow-xl rotate-1 border border-stone-100 flex flex-col">
                      ...
                      {selectedLetter.images.length > 1 && (
                        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-between px-2">
                          <button 
                            ...
                            className="bg-white/90 p-1.5 rounded-full shadow-md active:scale-90 transition-transform"
                          >
